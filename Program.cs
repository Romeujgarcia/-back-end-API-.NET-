...
{
    app.UseExceptionHandler("/Home/Error"); // URL de tratamento de erro
    app.UseHsts();
}

app.UseHttpsRedirection();
app.UseCors("AllowSpecificOrigin"); // Antes de UseAuthentication e UseAuthorization// Adiciona CORS
